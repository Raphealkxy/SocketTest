...
public class registerFace3 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_face3);
        init();

    }
    private void init() {
        take_photo= (Button) findViewById(R.id.take_photo3);
        getImage= (Button) findViewById(R.id.btn_getImage3);
        submit= (Button) findViewById(R.id.btn_register3);
        tip= (TextView) findViewById(R.id.tip3);
        imageView= (ImageView) findViewById(R.id.image_pic3);
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            case R.id.btn_getImage3:
                getImage();
                break;
            case R.id.take_photo3:
                take_photo();
                break;
            case R.id.btn_register3:
                break;
            default:
                break;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_PICTURE_CHOOSE) {
            ...
            if(null != bmp){
                FaceUtil.saveBitmapToFile(registerFace3.this, bmp);
            }
            // 获取图片保存路径
            fileSrc = FaceUtil.getImagePath(registerFace3.this);
            //       showTip(fileSrc);
            // 获取图片的宽和高
